    ...
    <body>
        ...
        <section class="tm-section">
            <div class="container">
                ...
                <input type="text" name="cat_name" value="<?php echo set_value('cat_name', $category->cat_name) ?>" class="form-control" placeholder="Judul"  />
                                    
                    </div>

                    <div class="form-group">
                <textarea type="text" name="cat_description" value="" class="form-control" rows="6" placeholder="Deskripsi" ><?php echo set_value('cat_description', $category->cat_description) ?></textarea>                
                    </div>
